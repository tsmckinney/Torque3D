...
void OpenVRProvider::staticInit()
{
   ...
   Con::setIntVariable("$OpenVR::OverlayFlags_SideBySide_Parallel", vr::VROverlayFlags_SideBySide_Parallel);
   Con::setIntVariable("$OpenVR::OverlayFlags_SideBySide_Crossed", vr::VROverlayFlags_SideBySide_Crossed);
   ...
   Con::setIntVariable("$OpenVR::OverlayFlags_MakeOverlaysInteractiveIfVisible", vr::VROverlayFlags_MakeOverlaysInteractiveIfVisible);
   ...
   Con::setIntVariable("$OpenVR::OverlayFlags_IgnoreTextureAlpha", vr::VROverlayFlags_IgnoreTextureAlpha);
   Con::setIntVariable("$OpenVR::OverlayFlags_EnableControlBarKeyboard", vr::VROverlayFlags_EnableControlBarKeyboard);
   Con::setIntVariable("$OpenVR::OverlayFlags_EnableControlBarClose", vr::VROverlayFlags_EnableControlBarClose);
   Con::setIntVariable("$OpenVR::OverlayFlags_EnableClickStabilization", vr::VROverlayFlags_EnableClickStabilization);
   Con::setIntVariable("$OpenVR::OverlayFlags_MultiCursor", vr::VROverlayFlags_MultiCursor);
